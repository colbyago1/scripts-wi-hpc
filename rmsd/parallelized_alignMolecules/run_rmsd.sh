...
do
    ...
    job_id=$(/wistar/kulp/software/slurmq --sbatch "/home/cagostino/work/scripts/rmsd/parallelized_alignMolecules/rmsd_alignMolecules.sh $reference $file" | awk '/Submitted batch job/ {print $4}')
    job_ids+=("$job_id")
done
