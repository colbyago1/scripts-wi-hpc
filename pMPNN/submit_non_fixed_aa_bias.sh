...
#SBATCH --output=mpnn_sol_aabs_nf.out
#SBATCH --job-name=mpnn_sol_aabs_nf
#SBATCH --gres=gpu:1
...
AA_list="D E H K N Q R S T A V I L M F Y W"
bias_list="1.39 1.39 1.39 1.39 1.39 1.39 1.39 1.39 1.39 -1.39 -1.39 -1.39 -1.39 -1.39 -1.39 -1.39 -1.39"
python /home/cagostino/work/software/ProteinMPNN/helper_scripts/make_bias_AA.py --output_path=$path_for_bias --AA_list="$AA_list" --bias_list="$bias_list"
