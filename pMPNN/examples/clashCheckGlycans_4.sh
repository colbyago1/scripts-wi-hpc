...
substrings=("ENVTEE" "NGTGPCP" "GST" "RNLSEIWDNMTWLQWDK")
ref="/home/cagostino/work/workspace/gp120-gp41_interface/35O22/4TVP/rfDiffusion/4TVP_contigs.pdb"
...
for pdb in *pdb; do
    ...
    cat <(echo "TER") Ab <(echo "TER") <(echo "END")  >> "${pdb::-4}_cc.pdb"
