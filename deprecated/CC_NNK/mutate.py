...
def mutate(pdb_filename, posi1, posi2, pose, scorefxn):
    ...
    if(((center_of_mass(testPose,posi1,posi1)-center_of_mass(testPose,posi2,posi2)).norm()<12) and abs(posi1 - posi2) != 1):
...
for mutate_position in mutate_positions:
        mutate(pdb_filename, mutate_posi, mutate_position, pose, scorefxn)
