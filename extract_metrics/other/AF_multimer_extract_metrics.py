...
# tm info and move files
csv_file_path = "output_files/AF_tm.csv"
with open(csv_file_path, mode='w') as csv_file: csv_file.write("filename,iptm+ptm" + '\n')
...
with open(csv_file_path, mode='w') as csv_file: csv_file.write("filename,pLDDT" + '\n')
...
# merge df
df1 = pd.read_csv("output_files/AF_pkl.csv")
df2 = pd.read_csv("output_files/AF_tm.csv")
