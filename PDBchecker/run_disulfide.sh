...
/home/dwkulp/software/mslib/bin/findDisulf --pdb "$pdb" --disulfPdb /home/dwkulp/wistar/data/disulfides/full_pdb_190722/CYS_CYS.bin --speak findDisulfides --binaryDB --modelBest --noOutputPdb > "${pdb::-4}.log"
