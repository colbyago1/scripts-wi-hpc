...
def mutate(pose, posi, amino, partners, ID, bool_relax):
    ...
    content=(str(bound)+','+str(unbound)+','+str(binding)+','+str(wt_energy)+','+str(binding/wt_energy)+'\n')
...
mutate(pdb_filename, mutate_position, amino_acid, partners, identifier, relax)
